...
class Settings(BaseSettings):
    ...
    zarr_store_url: Optional[str] = None  # e.g. s3://bucket/zarr

    # Data source credentials
    era5_cds_api_key: Optional[str] = None
    era5_cds_api_url: str = "https://cds.climate.copernicus.eu/api"
    copernicus_dataspace_client_id: Optional[str] = None
    copernicus_dataspace_client_secret: Optional[str] = None
